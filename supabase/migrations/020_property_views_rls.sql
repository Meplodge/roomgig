...
DROP POLICY IF EXISTS "Allow public insert for property views" ON property_views;
...
DROP POLICY IF EXISTS "Allow users to view own property views" ON property_views;
...
DROP POLICY IF EXISTS "Allow service role full access" ON property_views;
